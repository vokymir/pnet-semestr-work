...
namespace Api.Migrations
{
    ...
    [Migration("20250728091002_NotValidRecordsRethought")]
    partial class NotValidRecordsRethought
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BirdWatching.Shared.Model.Record", b =>
                {
                    ...
                    b.Property<string>("LocationDescribed")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("EventRecord", b =>
                {
                    b.Property<int>("InvalidInEventsId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("NotValidRecordsId")
                        .HasColumnType("INTEGER");

                    b.HasKey("InvalidInEventsId", "NotValidRecordsId");

                    b.HasIndex("NotValidRecordsId");

                    b.ToTable("InvalidRecordsInEvents", (string)null);
                });
            ...
            modelBuilder.Entity("EventRecord", b =>
                {
                    b.HasOne("BirdWatching.Shared.Model.Event", null)
                        .WithMany()
                        .HasForeignKey("InvalidInEventsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BirdWatching.Shared.Model.Record", null)
                        .WithMany()
                        .HasForeignKey("NotValidRecordsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
